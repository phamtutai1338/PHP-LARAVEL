...
<aside class="app-sidebar">
    <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="../img/hacker.jpg"  "
                                        alt="User Image">
        <div>
                ...
                <div class="tile-body">
                    ...
                    <div class="row element-button">
                        <div class="col-sm-2">
                            ...
                            <a class="btn btn-add btn-sm" href="form-thêm-sinh-vien.php" title="Thêm"><i class="fas fa-plus"></i>
